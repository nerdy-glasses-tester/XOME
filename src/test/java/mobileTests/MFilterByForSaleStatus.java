...
public class MFilterByForSaleStatus extends TestBase{
	...
	final static Logger log = LogManager.getLogger(MFilterByForSaleStatus.class);
	
	
	static String className = MFilterByForSaleStatus.class.getSimpleName();
